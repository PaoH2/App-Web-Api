...
class EventoView(generics.CreateAPIView):
    ...
    def post(self,request, *args, **kwargs):
            ...
            evento = Evento.objects.create(
                                            ...
                                            fecha= request.data["fecha_evento"],
                                            ...
                                            responsable = request.data["responsable_evento"],
...
class EventosViewEdit(generics.CreateAPIView):
    ...
    def put(self, request, *args, **kwargs):
        try:
            ...
            evento.tipo = request.data.get("tipo_evento", evento.tipo)
            ...
            evento.responsable = request.data.get("responsable_evento", evento.responsable)
